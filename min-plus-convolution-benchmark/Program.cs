...
using min_plus_convolution_benchmark;
...
void SanityCheck(int n = 100)
{
...

    {
        ...
        foreach (var pair in MinPlusConvolutionBalancedStaircaseBenchmarks.StairCurvePairs)
        {
            ...
            if (!pair.a.IsLeftContinuous)
            {
                Console.WriteLine($"NOT LEFT-CONTINUOUS:");
                Console.WriteLine(pair.a.ToCodeString());
            }

            if (!pair.b.IsLeftContinuous)
            {
                Console.WriteLine($"NOT LEFT-CONTINUOUS:");
...

    {
        ...
        MinPlusConvolutionHorizontalKTradeoffStaircaseBenchmarks.TestsCount = testsCount;
        Console.WriteLine();
        Console.WriteLine();
    }
}
